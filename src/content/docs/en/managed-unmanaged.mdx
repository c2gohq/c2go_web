...
sourceLinks:
  - label: Managed pointer regression test
    url: https://github.com/c2gohq/c2go_clang/blob/v0.20260729.0-rc.5/clang/test/CodeGen/c2go-managed-addrspace.c
  - label: Layout safety checks
    url: https://github.com/c2gohq/c2go_clang/blob/v0.20260729.0-rc.5/clang/test/Sema/c2go-unmanaged-record-managed-field-reject.c
...
unmanaged extern int vendor_write(struct NativeBuffer *buffer);
```
