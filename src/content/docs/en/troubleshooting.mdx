...
sourceLinks:
  - label: Known limitations
    url: https://github.com/c2gohq/c2go_clang/blob/v0.20260729.0-rc.5/docs/c2go/user-guide.md#8-known-limitations-and-constraints
...
Check pointer ownership, stack-address escape, inline-assembly clobbers, and calls that cross native boundaries. A green compiler test is not a substitute for an end-to-end `go test` using the generated package.
