...
sourceLinks:
  - label: Unmanaged import manifest test
    url: https://github.com/c2gohq/c2go_clang/blob/v0.20260801.0-rc.2/clang/test/CodeGen/c2go-unmanaged-extern-manifest.c
  ...
  - label: c2go-libc PureGo bridge
    url: https://github.com/c2gohq/c2go_libc/blob/v0.20260801.0-rc.2/dl/dispatch_unix.go
---
