...
每个扩展的完整拼写、类别和限制见 [C2Go 扩展速查](/zh-cn/docs/c2go-extensions/)。
...
发布页列出真正构建并测试过的宿主 SDK。迁移现有 C 库前，请阅读[平台与当前限制](/zh-cn/docs/platforms-limitations/)；语言、ABI、回调与打包边界以该页为准。
...
先[安装匹配的 SDK](/zh-cn/docs/installation/)与 Go runtime module，然后在 [Hello World](/zh-cn/docs/hello-world/) 中编译第一个导出 C 函数。
